...
checkpointer = ModelCheckpoint(filepath='fold.h5', verbose=1, save_best_only=True)
...
file.write(str(acc));
file.close()
file=open('acc_val.txt','a')
file.write(str(val_acc));
file.close()
file=open('loss.txt','a')
file.write(str(loss));
file.close()
file=open('loss_val.txt','a')
