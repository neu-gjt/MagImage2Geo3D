...
checkpointer = ModelCheckpoint(filepath='fault.h5', verbose=1, save_best_only=True)
...
file=open('acc_fault.txt','a')
file.write(str(acc));
file.close()
file=open('acc_val_fault.txt','a')
file.write(str(val_acc));
file.close()
file=open('loss_fault.txt','a')
file.write(str(loss));
file.close()
file=open('loss_val_fault.txt','a')
