...
xpath=r'.\data\train\tilt_fault'
filelist = os.listdir(xpath) 
images=[]
labels=label

val_label = np.loadtxt(r'val.txt')
val_xpath=r'.\data\val\tilt_fault'
...
checkpointer = ModelCheckpoint(filepath='tilt_fault.h5', verbose=1, save_best_only=True)
